...
import static com.paulhammant.buildradiator.root.BuildRadiatorRoot.DEMO_RADIATOR_CODE;
import static com.paulhammant.buildradiator.root.BuildRadiatorRoot.NO_UPDATES;
import static com.paulhammant.buildradiator.root.TestVersionOfBuildRadiatorApp.CONTRIVED_FOR_TESTING;
import static com.paulhammant.buildradiator.root.hamcrest.HasNewRadiator.captureCreatedRadiator;
import static com.paulhammant.buildradiator.root.hamcrest.IgnoringLastUpdatedFieldTheRadiatorIsTheSameAs.ignoringLastUpdatedFieldTheRadiatorIsTheSameAs;
...
public class RadiatorIntegrationTest {
    ...
    public void knownCodeHasListOfBuildsAvailableAsJson() throws InterruptedException {
        ...
        get("/r" + CONTRIVED_FOR_TESTING + "/RAD_CODE" )
                .then()
                .assertThat()
    ...
    public void radiatorCanBeCreatedAndTransformUnderscoresInStepNames() {
        ...
        given()
            ...
            .when()
                .post("/r" + CONTRIVED_FOR_TESTING + "/create")
            .then()
                .statusCode(200)
    ...
    public void radiatorCanBeUpdatedWithRestrictedIpAddresses() {
        ...
        given()
            ...
            .when()
                .post("/r"  + CONTRIVED_FOR_TESTING +"/aaa/updateIps")
            .then()
                .statusCode(200)
                .body(equalTo("OK"));
    ...
    public void demoRadiatorCannotBeUpdated() {
        ...
        for (String barredOperation : stepNames("startStep", "stepPassed", "stepFailed", "buildCancelled")) {
            given()
                ...
                .when()
                    .post("/r" + CONTRIVED_FOR_TESTING + "/" + DEMO_RADIATOR_CODE + "/" + barredOperation)
                .then()
                    .statusCode(200)
    ...
    public void radiatorCanBeUpdatedWithWithCancelledBuild() {
        ...
        given()
            ...
            .when()
                .post("/r" + CONTRIVED_FOR_TESTING + "/aaa/buildCancelled")
            .then()
                .statusCode(200)
                .body(equalTo("OK"));
    ...
    public void radiatorCanBeUpdatedWithWithBuildStepCompletion() {
        ...
        given()
                .params("build", "1", "step", "A", "secret", "sseeccrreett")
            .when()
                .post("/r" + CONTRIVED_FOR_TESTING + "/aaa/stepPassed")
            .then()
                .statusCode(200)
                .body(equalTo("OK"));
    ...
    public void radiatorCanBeUpdatedWithWithBuildStepFailure() {
        ...
        given()
                .params("build", "1", "step", "A", "secret", "sseeccrreett")
            .when()
                .post("/r" + CONTRIVED_FOR_TESTING + "/aaa/stepFailed")
            .then()
                .statusCode(200)
                .body(equalTo("OK"));
    ...
    public void unknownCodeHasNoBuildsList() {
        ...
        when()
                .get("/r" + CONTRIVED_FOR_TESTING + "/wewwewwewe/")
            .then()
                .assertThat()
    ...
    public void radiatorStoreCannotBeGotIfCodeIsTooLong() {
        ...
        when()
                .get("/r" + CONTRIVED_FOR_TESTING + "/12345678901234567890123")
            .then()
                .assertThat()
    ...
    private void postStepStartedAndConfirmTestResponse(String radCode, String secret, String buildId, String stepName, int expectedStatusCode, String expectedBody) {
        given()
            ...
            .when()
                .post("/r" + CONTRIVED_FOR_TESTING + "/" + radCode + "/startStep")
            .then()
